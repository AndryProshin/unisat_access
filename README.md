...
│   ├── parameters.py               # Класс Parameters для формирования параметров запроса метаданных
│   ├── metadata.py                 # Класс Metadata для получения метаданных и работы с ними
│   ├── scene.py                    # Класс Scene скачивание фрагментов и получение продуктов 
├── 📁processing
│   ├── 📁gdal
...
Создайте файл .env в корне проекта (указаны фиктивные адреса):
